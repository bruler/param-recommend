...
LFM::LFM(SparseMatrix* _matrix, int _type, int _num_factor, double _sigma){
  matrix = _matrix;
  type = _type;
...
bool LFM::init_params(double* v, int size){
